...
export const workouts: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'triceps-french', prescribedExerciseId: 'triceps-french', prescribedExerciseIds: ['triceps-french', 'triceps-rope'], sets: 3, repsMin: 10, repsMax: 15 },
    ],
  },
  {
    id: 'C',
    ...
    exercises: [
      { id: 'hack-squat-c', prescribedExerciseId: 'squat', prescribedExerciseIds: ['squat', 'hack-squat'], label: 'Hack Squat ou agachamento', sets: 3, repsMin: 8, repsMax: 12 },
      { id: 'leg-curl-c', prescribedExerciseId: 'lying-leg-curl', prescribedExerciseIds: ['lying-leg-curl', 'seated-leg-curl'], label: 'Cadeira ou mesa flexora', sets: 3, repsMin: 10, repsMax: 15 },
      { id: 'chest-press', prescribedExerciseId: 'chest-press', sets: 3, repsMin: 8, repsMax: 12 },
      { id: 'machine-row', prescribedExerciseId: 'machine-row', prescribedExerciseIds: ['machine-row', 't-bar-row'], sets: 3, repsMin: 8, repsMax: 12 },
